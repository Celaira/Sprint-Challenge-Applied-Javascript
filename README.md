...
1. What is the DOM?
    ...
    A representation of the html elements of a webpage as an object. It can also be likened to a bridge between the content and the browser.
...
3. What is an event listener?
    ...
    A function that takes two arguments: the event, and the callback that should fire when the event occurs.

4. Why would we convert a NodeList into an Array?

    To have access to the full breadth of array methods.

5. What is a component?

    Reusable code that is comprised of HTML, CSS, and JS.
